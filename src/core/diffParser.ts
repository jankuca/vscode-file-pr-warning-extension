 ...
 */
export function mapHunksToLocalFile(hunks: DiffHunk[], localContent: string): LineRange[] {
...
function findSequenceNear(haystack: string[], needle: string[], hint: number): number {
